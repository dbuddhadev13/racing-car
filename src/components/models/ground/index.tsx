...
const Ground = () => {
  ...
  const gridMap = useLoader(TextureLoader, '/3d/textures/ground/grid.png')

  const aoMap = useLoader(TextureLoader, '/3d/textures/ground/ground-ao.png')

  const alphaMap = useLoader(TextureLoader, '/3d/textures/ground/alpha-map.png')
