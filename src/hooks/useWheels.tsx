...
export const useWheels = (
  ...
  front: number,
  radius: number,
): [Ref<Object3D<Object3DEventMap>>[], WheelInfoOptions[]] => {
  const wheels = [
    useRef<Object3D<Object3DEventMap>>(null!),
    useRef<Object3D<Object3DEventMap>>(null!),
    useRef<Object3D<Object3DEventMap>>(null!),
    useRef<Object3D<Object3DEventMap>>(null!),
  ]

  const wheelInfo: Omit<WheelInfoOptions, 'chassisConnectionPointLocal' | 'isFrontWheel'> = {
    radius,
